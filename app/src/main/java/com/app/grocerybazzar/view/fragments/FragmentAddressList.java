...
import com.app.grocerybazzar.adapter.AdapterAddressList;
 ...
 */
public class FragmentAddressList extends Fragment implements CompleteListener {
    ...
    void getAddreses(){
        ...
        serviceConnection.sendToServer(C.BASE_URL_USERS,C.addresses,hashMap,C.MSG,FragmentAddressList.this);
    }
        ...
        try {
            ...
            if (addressInfo.getStatus().equals(C.SUCSESS)) {
                if(addressInfo.getAddresses()!=null &&addressInfo.getAddresses().size()>0 ) {
                    ...
                    adapterAddressList = new AdapterAddressList(addressInfo.getAddresses(), getActivity());
